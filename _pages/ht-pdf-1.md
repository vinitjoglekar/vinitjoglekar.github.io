...
3. The embedded JavaScript may some times be viewed by opening a PDF file in a text editor. However, this is not a guaranteed way, because the JavaScript code may be compressed and embedded in a stream. In this case, it will not readable in a text editor.
